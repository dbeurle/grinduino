...
void presetFunctions()
{
    ...
    {                 // when up is pressed and select is not engaged then
        lcdState = 1; // lcdState is 1.
    }                 //
    else if ((downState == 1) && (selectState == 0))
    {                 // when down is pressed and select is not egnaged then
        lcdState = 0; // lcdState is 0.
    }
    ...
    { // when preset 1 is shown and the active button is pressed
        ...
        pOneMillisLength = (previousMillis
                            + pOneMillis); // create the milliSecond value that this while loop should stop at
    ...
    { // when preset 2 is shown and the active button is pressed
        ...
        pTwoMillis = (presetTwoVal * 100); // convert presetTwoVal from its EEPROM friendly form
                                           // into a milliSecond friendly value
        pTwoMillisLength = (previousMillis
                            + pTwoMillis); // create the milliSecond value that this while loop should stop at
